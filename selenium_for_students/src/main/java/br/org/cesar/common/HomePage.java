...
/**
 * Pagina que disponibiliza os servicos  presentes na home page do CLASSEDETESTES.WORDPRESS.COM
 * @author jcan
 *
 */
public class HomePage {
	...
	/**
	 * Definicao dos locators utilizados na pagina
	 */
//	static By homeMenuItem = By.id("menu-item-103"); //O item de menu pode ser acessado por id ou pelo texto exibido no link
	...
	// static By seleniumMenuItem = By.linkText("SELENIUM");//alterei ak
	static By seleniumMenuItem = By.id("menu-item-6");
	//static By cursoSeleniumSubMenuItem = By.linkText("CURSO SELENIUM");//alterei ak
	static By cursoSeleniumSubMenuItem = By.id("menu-item-52");
	//static By formularioSimplesMenuItem = By.linkText("FORMULARIO SIMPLES");//alterei ak
	static By formularioSimplesMenuItem = By.id("menu-item-51");
	...
	//	wait.until(ExpectedConditions.elementToBeClickable(seleniumMenuItem));//descomentei ak
	...
	/**
	 * Verifica se o titulo da pagina (exibido no navegador) o esperado
	 */
	public static void isHeaderTitleCorrect(String expectedTitle){
		assertThat("Titulo da pagina Incorreto", driver.findElement(pageHeaderTitle).getText(), is(expectedTitle));
	}
	...
	public static void isTitleCorrect(String expectedTitle){
		assertThat("Titulo Incorreto", driver.getTitle(), is(expectedTitle));
		 // em caso de falha:
	     // messagem de erro:
	     // Tittulo Incorreto
	...
	/**
	 * Verifica se o titulo da pagina de resultados de busca  correto
	 */
	public static void isSearchResultCorrect(String expectedTitle){
		 assertThat("Titulo Incorreto",  driver.findElement(searchResultsTitle).getText(), is(expectedTitle));
		//assertEquals(expectedTitle, driver.findElement(By.cssSelector("h1.page-title")).getText());
	}
