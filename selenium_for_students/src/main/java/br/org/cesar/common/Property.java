...
public abstract class Property {
	...
	public static String PHANTOMJS_DRIVE_PATH; // EU
	...
	static{
		...
		//FIREFOX_DRIVE_PATH = new File("").getAbsolutePath() + "C:\\Program Files (x86)\\Mozilla Firefox\\firefox.exe";
		FIREFOX_DRIVE_PATH = new File("").getAbsolutePath() + "\\src\\main\\resources\\geckodriver.exe"; // eu
		PHANTOMJS_DRIVE_PATH = new File("").getAbsolutePath() + "\\src\\main\\resources\\phantomjs.exe"; // eu
