...
public class FormularioSimplesPage {
	...
	static By enviarButtonLocator = By.className("pushbutton-wide");//eu
	...
	/**
	 * Clica no botao enviar do formulario simples
	 */
	...
	public static void assertSuccessMessageIsShown(){
		...
		assertThat("Mensagem de Sucesso  correta",  driver.findElement(tituloMensagemFormularioSimples).getText(), is("A mensagem foi enviada (voltar)"));
	}
	...
	public static void assertErrorMessageIsShown() {
		Utils.isVisible(tituloMensagemFormularioSimples);
		assertThat("Mensagem de Erro correta", driver.findElement(tituloMensagemFormularioSimples).getText(), is("Erro!"));
	}

	/**
	 * Verifica se a mensagem de erro detalhada
	 *  exibida submeter o formulario
	...
	public static void assertDetailedErrorMessageIsShown(String errorMessage){
		...
		assertThat("Mensagem detalhad errada", driver.findElement(mensagemDetalhadaFormularioSimples).getText(), is(errorMessage));
	}
